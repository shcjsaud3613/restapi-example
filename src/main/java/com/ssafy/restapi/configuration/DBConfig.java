package com.ssafy.restapi.configuration;
...
@EnableJpaRepositories(
        basePackages = "com.ssafy.restapi.repository", // TODO Repository 패키지 지정
...
public class DBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder.dataSource(dataSource)
                .packages("com.ssafy.restapi.model") // TODO Model 패키지 지정
                .properties(map)
                .build();
    }
